...
* The sample requires a bash shell, in Windows you can use Git for Windows or Cygwin. These two environments include openssl, which we'll use to generate a self-signed certificate.
